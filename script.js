...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const elements = document.querySelectorAll('.service-card, .product-card, .stat');
...
const revealElements = document.querySelectorAll('.service-card, .product-card, .about-text, .about-visual');
